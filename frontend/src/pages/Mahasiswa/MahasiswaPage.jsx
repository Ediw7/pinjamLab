            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              {isLoading ? (
                ...
                <div className="overflow-x-auto">
                  ...
                  <table className="min-w-full bg-white">
                    <thead className="bg-gray-100">
                      <tr>
                        <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Barang</th>
                        <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Stok Total</th>
                        <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tersedia</th>
                ...
                <div className="text-center py-4 text-gray-500">
                  Silakan pilih lab terlebih dahulu
                </div>
              )}
            </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-medium text-gray-800">
                    Pinjam: {selectedBarang.nama_barang}
                  </h3>
                  <button 
